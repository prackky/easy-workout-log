    ...
    <div className="container grid-sm section-content">
      <div className="columns">
        <div className="column col-12">
          ...
          <h5 className="margin-top-1rem">Version 2.3.0 (2017-07-23)</h5>
          <ul className="change-log">
          ...
          <h5 className="margin-top-1rem">Version 2.1.0</h5>
          <ul className="change-log">
            <li>Support for global notifications</li>
          </ul>
          
          <h5 className="margin-top-1rem">Version 2.0.0</h5>
          <ul className="change-log">
          ...
          <h5 className="margin-top-1rem">Version 1.1.0</h5>
          <ul className="change-log">
          ...
          <h5 className="margin-top-1rem">Version 1.0.1</h5>
          <ul className="change-log">
          ...
          <h5 className="margin-top-1rem">Version 0.4.0</h5>
          <ul className="change-log">
